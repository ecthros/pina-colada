...
class TCPKiller(Capability):
    ...
    def __init__(self, core):
        ...
        self.options = {
            ...
            "allow-source":             Option("allow-source", False, "do not attack this ip address's connections, but only if it's the source of a packet", False),
            "allow-destination":        Option("destination-source", False, "do not attack this ip address's connections, but only if it's the destination of a packet", False),
            "target":                   Option("target", "0.0.0.0", "actively target given ip address, whether it is the source or destination of a packet", False),
            "target-source":            Option("target-source", "0.0.0.0", "actively target this ip address, but only if it's the source of a packet", False),
            "target-destination":       Option("target-destination", "0.0.0.0", "actively target this ip address, but only if it's the destination of a packet", False),
            "allow-port":               Option("allow-port", None, "do not attack any connections involving this port, whether it's the source or destination of a packet", False),
            "allow-source-port":        Option("allow-source-port", None, "do not attack any connections involving this port, but only if it's the source of a packet", False),
            "allow-destination-port":   Option("allow-source-port", None, "do not attack any connections involving this port, but only if it's the destination of a packet", False),
            "target-port":              Option("target-port", None, "actively target any connections involving these ports whether it is the source or destination of a packet", False),
            "target-source-port":       Option("target-source-port", None, "actively target any connections involving this port, but only if it's the source", False),
            "target-destination-port":  Option("target-source-port", None, "actively target any connections involving this port, but only if it's the destination", False),
